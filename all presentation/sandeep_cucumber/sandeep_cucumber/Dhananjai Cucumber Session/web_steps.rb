...
Then /^"([^"]*)" should be selected for "([^"]*)"$/ do |value,field|
  field_labeled(field).element.search("//option[@selected = 'selected' and contains(string(), '#{value}')]")
end

Given /^I have login username"([^"]*)" and password "([^"]*)"$/ do |name, password|
  User.create(:username => name, :password => password)
end

when /^I have logged in as username "([^"]*)" and password "([^"]*)"$/ do |name, password|
